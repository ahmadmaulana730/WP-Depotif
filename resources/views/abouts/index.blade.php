...
<section class="page-banner">
    ...
    <div class="banner-inner">
        <div class="faded-text light"><div class="f-text"><span>About</span></div></div>
...
<section class="welcome-section">
    <div class="auto-container">
        <div class="content">
            ...
            <div class="sub-title">2022</div>
            <h2>We create the world more better with Technology </h2>
...
<section class="services-section-four">
    ...
    <div class="faded-text"><div class="f-text"><span>services</span></div></div>
    <div class="auto-container">
